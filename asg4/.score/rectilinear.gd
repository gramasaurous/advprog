# $Id: rectilinear.gd,v 1.1 2014-05-20 14:01:32-07 - - $
...
define r_t right_triangle 50 100
define iso isosceles 100 120
define equi equilateral 100 
draw red rect 100 100
draw cyan squ 200 100
draw yellow card 300 100
draw magenta tri 100 300
draw PapayaWhip r_t 150 150
draw LemonChiffon3 iso 200 300
